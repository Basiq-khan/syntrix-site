export function WhatWeDo() {
  return (
    <section className="-z-5 w-full bg-[#3C222D] text-white pt-15 pb-15 md:pt-55 md:pb-35 px-4 sm:px-6 md:px-10">
      <div className="max-w-355 mx-auto flex flex-col gap-12 md:gap-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          ...
          <div className="flex gap-24">
            ...
            <h2 className=" font-['Anton']  font-normal text-[36px] sm:text-[50px] md:text-[65px] lg:text-[75px] leading-[1.05] uppercase tracking-wide">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-[#262626] p-6 sm:p-8  flex flex-col px-7 justify-between min-h-120 group hover:bg-[#2e2e2e] transition-all duration-300">
            <div className="flex flex-col gap-4">
              ...
              <p className="font-['Inter_Variable'] text-[14px] text-white/70 leading-relaxed w-80 font-light">
                Lorem ipsum do adipiscing elit Ut elit tellus luctus nec ullamcorper mattis pulvinar dapibus leo.
              </p>
            </div>
            <div className="mt-6 overflow-hidden">
              <img 
                src="public/working-job-career-casual-showing-SJZWF3N-800x533.jpg.png" 
                alt="Brand Strategy" 
          ...
          <div className="bg-[#EBF264] p-6 sm:p-8 flex flex-col justify-between min-h-[480px] shadow-xl">
            <div className="flex flex-col gap-6">
              <div className="overflow-hidden">
                <img 
                  src="public/working-job-career-casual-showing-8GNF7UD-800x533.jpg.png" 
            ...
            <p className="font-['Inter_Variable'] text-[14px] text-black leading-relaxed w-80 font-light mt-4">
              Lorem ipsum do adipiscing elit Ut elit tellus luctus nec ullamcorper mattis pulvinar dapibus leo.
            </p>
          </div>
          ...
          <div className="bg-[#262626] p-6 sm:p-8 flex flex-col justify-between min-h-[480px] group hover:bg-[#2e2e2e] transition-all duration-300 md:col-span-2 lg:col-span-1">
            ...
            <div className="mt-6 overflow-hidden">
              <img 
                src="public/group-of-creative-people-working-and-brainstorming-F9J86RY-800x533.jpg.png" 
