export function TypographySection() {
  return (
    <section className="w-full bg-[#3C222D] py-16 sm:py-24 md:py-32 px-4 sm:px-8 md:px-16 flex flex-col items-center justify-center overflow-hidden">
      
      {/* -------------------------------------------------------- */}
      {/* MAIN TEXT WRAPPER GRID BLOCK */}
      {/* -------------------------------------------------------- */}
      <div className="w-full max-w-[1320px] text-center text-white font-['Anton'] font-normal text-[32px] sm:text-[44px] md:text-[60px] leading-[1.2] md:leading-[1.25] uppercase tracking-wide select-none">
      ...
      {/* -------------------------------------------------------- */}
      <div className="mt-16 md:mt-24 flex items-center justify-center gap-2">
