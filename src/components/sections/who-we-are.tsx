export function WhoWeAre() {
  return (
    <section className="w-full text-[#3C222D] py-16 md:pt-35 md:pb-78 px-4 sm:px-6 md:px-10 overflow-hidden" 
    ...
    >
      <div className="max-w-[1420px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-3 items-center">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6 md:gap-4 z-10">
          ...
          <div className="flex flex-col gap-5 mt-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="font-['Anton'] font-normal text-[16px] sm:text-[32px] uppercase tracking-wide">
        ...
        <div className="lg:col-span-4 flex justify-center items-end relative min-h-[350px] sm:min-h-[450px] lg:h-full mt-6 lg:mt-30">
          {/* Decorative Back Box */}
          <div className="absolute w-[240px] h-[300px] sm:w-[330px] sm:h-[360px] border-black border-6 bg-[#FD683E] rounded-sm bottom-3 translate-y-2 z-0 "></div>
        ...
        <div className="lg:col-span-4 flex flex-col gap-5 z-10 w-full">
          ...
          <div className="w-full h-[200px] self-start lg:self-end">
            <img 
